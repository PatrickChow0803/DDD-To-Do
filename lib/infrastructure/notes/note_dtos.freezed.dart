...
mixin _$NoteDto {
  ...
  int get color;
  List<TodoItemDto>
      get todos; // instead of DateTime, use FieldValue with Firestore. FieldValue is a Placeholder --> Time-on-the-server
...
class _$_NoteDto extends _NoteDto {
  ...
  @override // instead of DateTime, use FieldValue with Firestore. FieldValue is a Placeholder --> Time-on-the-server
  @ServerTimestampConverter()
